...
export const createCartSlice: StateCreator<Store, [['zustand/immer', never]], [], CartSlice> = (set, get) => ({
    ...initialState,
    ...
    getProductById: (productId) => get().products.find((product) => productId === product.id),
